...
export const el = {
  ...
  groepBtn: document.getElementById("groep-btn"),
  snelToevoegenRij: document.getElementById("snel-toevoegen-rij"),
  catBeheerBtn: document.getElementById("cat-beheer-btn"),
  catKiesMenu: document.getElementById("cat-kies-menu"),
  catKiesTitel: document.getElementById("cat-kies-titel"),
  catKiesOpties: document.getElementById("cat-kies-opties"),
  catBeheerMenu: document.getElementById("cat-beheer-menu"),
  catBeheerLijst: document.getElementById("cat-beheer-lijst"),
  catBeheerAddBtn: document.getElementById("cat-beheer-add-btn"),
  catBeheerCloseBtn: document.getElementById("cat-beheer-close-btn"),
};
